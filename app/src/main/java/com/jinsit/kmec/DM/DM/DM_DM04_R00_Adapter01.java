...
/**
 * 근태현황 주차에 대한 Adapter. 사용하지 않음.
 * @deprecated
 * @author 이창헌
 *
 */
public class DM_DM04_R00_Adapter01 extends BaseAdapter {

	Context context;
	int layout;
	private List<DM_DM04_R00_ITEM01> dataList = null;
	private View.OnClickListener onClickListener;
	public DM_DM04_R00_Adapter01() {
		super();
		// TODO Auto-generated constructor stub
	}

	public DM_DM04_R00_Adapter01(Context context, int layout,
								 List<DM_DM04_R00_ITEM01> dataList, View.OnClickListener onClickListener) {
		super();
...
//		private TextView tv_dm_adapter_2week_statutory;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		final DM_DM04_R00_ITEM01 item = dataList.get(position);
...
//		holder.tv_dm_adapter_name.setText(item.getERP_NM());
