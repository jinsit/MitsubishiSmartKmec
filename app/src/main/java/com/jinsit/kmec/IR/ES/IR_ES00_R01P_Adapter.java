...
public class IR_ES00_R01P_Adapter extends BaseAdapter {

	private Context context;
	private int layout;
	private List<IR_ES00_R01P_Item> dataList = null;

	public IR_ES00_R01P_Adapter(){};
	public IR_ES00_R01P_Adapter(Context context, int layout, List<IR_ES00_R01P_Item> dataList) {
