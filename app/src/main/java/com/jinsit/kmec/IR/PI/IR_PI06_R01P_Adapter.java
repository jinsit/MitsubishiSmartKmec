...
public class IR_PI06_R01P_Adapter extends BaseAdapter{
	...
	public IR_PI06_R01P_Adapter(Context context,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.ir_pi06_r01p_adapter, null);
		...
		if("Y".equals(mData.getImageYN())){
			...
			holder.iv_pi06_partsImage.setImageResource(R.drawable.btn_nopicture);
