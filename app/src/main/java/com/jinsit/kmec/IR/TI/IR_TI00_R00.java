...
public class IR_TI00_R00 extends Activity implements OnItemClickListener
{
	private Context context;

	private ListView lv_ti_categoryClass;

	private List<IR_TI00_R00_ITEM01> itemList01;
	private IR_TI00_R00_Adapter01 adapter01;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ir_ti00_r00);
		activityInit();
	}
	...
	protected void activityInit() {
		...
		itemList01 = new ArrayList<IR_TI00_R00_ITEM01>();
		this.currentSelectedItem01 = null;
		inqueryCategoryClass();
	}

	protected void getInstances() {
		lv_ti_categoryClass = (ListView) findViewById(R.id.lv_ti_categoryClass);
		setEvents();
	}

	protected void setEvents() {
		lv_ti_categoryClass.setOnItemClickListener(this);
		setConfig();
	}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if(position > -1)
		{
			...
			Intent intent = new Intent(context, IR_TI01_R00.class);
	...
	public class selectCategoryClass extends AsyncTask<String, Integer, String> {
			...
			if (result.equals("bagicWorkTime")) {
				...
				try {
					...
					for (int i = 0; i < jsonSize; i++) {
						itemList01.add(new IR_TI00_R00_ITEM01(ejl01.getValue(i,"DOCU_H_CD"),
								ejl01.getValue(i, "DOCU_H_NM")
						));
					}
				} catch (JSONException e) {
					e.printStackTrace();
				...
				progress(false);
				adapter01 = new IR_TI00_R00_Adapter01(context,
						R.layout.ir_ti00_r00_adapter01, itemList01);
				IR_TI00_R00.this.lv_ti_categoryClass
						.setAdapter(adapter01);
			}
		}
	}// end of SelectData inner-class

	private void inqueryCategoryClass()
	{
		progress(true);
		new selectCategoryClass().execute("bagicWorkTime");
	}
	...
	private void progress(Boolean isActivated) {
		if (isActivated) {
			IR_TI00_R00.this.progress = android.app.ProgressDialog.show(
					context, "알림", "조회 중입니다.");
		} else {
			IR_TI00_R00.this.progress.dismiss();
		}
	}
	private IR_TI00_R00_ITEM01 currentSelectedItem01;
