 ...
 * @since 2011.03.08
 */
public class CalendarGridNoDataAdapter extends BaseAdapter
{
	...
	public CalendarGridNoDataAdapter(Context context, int textResource, ArrayList<DayInfoNoData> dayList)
	{
	...
	{
		final DayInfoNoData day = mDayList.get(position);
		...
		/*	if(position % 7 == 6)
			...
			*/
			...
			dayViewHolder.tvDay = (TextView) convertView.findViewById(R.id.tv_calendarDay);
