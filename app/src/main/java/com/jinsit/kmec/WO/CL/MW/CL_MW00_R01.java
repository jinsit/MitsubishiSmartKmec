 ...
 *
 */
public class CL_MW00_R01 extends Activity {
	...
	private void activityInit() {
		...
		btn_mw_r01jobComplete.setVisibility(View.GONE);
	...
	private void progress(Boolean isActivated) {
		if (isActivated) {
			CL_MW00_R01.this.progress = android.app.ProgressDialog.show(
					context, "알림", "조회 중입니다.");
		} else {
			CL_MW00_R01.this.progress.dismiss();
		}
	}
	...
	private class WorkTargetDetailAsync extends AsyncTask<Void, String, Void> {
		...
		protected void onPostExecute(Void result) {
			CL_MW00_R01.this.ProgressDialog.dismiss();
			try {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			CL_MW00_R01.this.ProgressDialog = android.app.ProgressDialog.show(
					CL_MW00_R01.this, "작업대상", "작업대상목록 불러오는중");
		}
