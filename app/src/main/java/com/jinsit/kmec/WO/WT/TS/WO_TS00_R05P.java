 ...
 * 고장수리
 */
public class WO_TS00_R05P extends AlertDialog implements OnClickListener, OnDismissListener, OnItemClickListener{

	public WO_TS00_R05P(Context context, String cbsCd1, List<WO_TS00_R04P_ITEM01> selecteItemList) {
		super(context);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		if(position > -1){
			...
			final WO_TS00_R06P wo06 = new WO_TS00_R06P(context,itemList01.get(position).getAssyCd(),currentselectedItemList01);
			wo06.show();
			wo06.inqueryCBSCode3();
			wo06.setOnDismissListener(new OnDismissListener() {
				@Override
				public void onDismiss(DialogInterface dialog) {
					// TODO Auto-generated method stub
					currentselectedItemList01 = wo06.getCurrentselectedItemList();
					dismiss();
				}
	...
	public class selectCBSCode2 extends AsyncTask<String, Integer, String> {
			...
			if (params[0].equals("bagicWorkTime")) {
				try {
					String param_url_01 = WebServerInfo.getUrl()
							+ "ip/selectCBSCode2.do";

					List<NameValuePair> arguments = new ArrayList<NameValuePair>();
					arguments.add(new BasicNameValuePair("cbsCd1",cbsCd1));
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals("bagicWorkTime")) {
				...
				WO_TS00_R05P.this.lv_fr_cbsCd1
						.setAdapter(adapter01);
			}
		}
	}// end of SelectData inner-class
	
	public void inqueryCBSCode2()
	{
		progress(true);
		new selectCBSCode2().execute("bagicWorkTime");
	}
	
	private void progress(Boolean isActivated) {
		if (isActivated) {
			WO_TS00_R05P.this.progress = android.app.ProgressDialog.show(
					context, "알림", "조회 중입니다.");
		} else {
			WO_TS00_R05P.this.progress.dismiss();
		}
	}
