...
public class CopyPartCheckListDataMng {
	...
	public CopyPartCheckListDataMng(String cS_EMP_ID, String wORK_DT,
	...
	public CopyPartCheckListDataMng() {
		super();
	}
	public CopyPartCheckListDataMng(String nFC_PLC,String plcNm) {
		super();
		NFC_PLC = nFC_PLC;
		NFC_PLC_NM = plcNm;
	}
	...
	public void appendRmk(String rmk){
		...
		if(rmk!=null&&!rmk.equals("")&&!rmk.equals("null")){
			if(this.INPUT_RMK.equals("")){
				this.INPUT_RMK = rmk;	
			}else{
				this.INPUT_RMK = this.INPUT_RMK +"\n" + rmk;	
			}
		}
	...
	public void addDefaultValue(int defaultValue){
		this.defvalue = this.defvalue+defaultValue;
