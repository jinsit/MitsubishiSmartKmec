...
public class WO_WT00_R01_ITEM00 {

	public WO_WT00_R01_ITEM00() {
		super();
	}
	
	public WO_WT00_R01_ITEM00(String cS_EMP_ID, String wORK_DT, String jOB_NO,
			String wORK_CD, String wORK_NM, String sT, String cS_DT, String cS_FR,
			String bLDG_NO, String bLDG_NM, String cAR_NO, String rESERV_ST,
			String aDDR, String mAIN_EMP_NM, String mAIN_EMP_PHONE,
			String sUB_EMP_NM, String sUB_EMP_PHONE, String cS_DEPT_NM,
			String nOTIFY_NM, String nOTIFY_PHONE, String rECEV_DESC,
			String rECEV_TM, String rESERV_TM, String rEPAIR_TM,
			String mOVE_TM, String aRRIVE_TM, String cOMPLETE_TM,
			String rESCUE_TM, String sTART_TM, String cONTACT_CD,
			String sTATUS_CD, String rEF_CONTR_NO, String pARTS_NO,
			String mODEL_NM, String rECEV_NO, String cHECK_YN, String cBS_YN) {
		super();
		...
		RESERV_ST = rESERV_ST;
		ADDR = aDDR;
		MAIN_EMP_NM = mAIN_EMP_NM;
		MAIN_EMP_PHONE = mAIN_EMP_PHONE;
		SUB_EMP_NM = sUB_EMP_NM;
		SUB_EMP_PHONE = sUB_EMP_PHONE;
	...
	public String ADDR;
	public String MAIN_EMP_NM;
	public String MAIN_EMP_PHONE;
	public String SUB_EMP_NM;
	public String SUB_EMP_PHONE;
	...
	public String getMAIN_EMP_NM() {
		return MAIN_EMP_NM;
	}
	public void setMAIN_EMP_NM(String mAIN_EMP_NM) {
		MAIN_EMP_NM = mAIN_EMP_NM;
	}
	public String getMAIN_EMP_PHONE() {
		return MAIN_EMP_PHONE;
	}
	public void setMAIN_EMP_PHONE(String mAIN_EMP_PHONE) {
		MAIN_EMP_PHONE = mAIN_EMP_PHONE;
	}
	public String getSUB_EMP_NM() {
		return SUB_EMP_NM;
	}
	public void setSUB_EMP_NM(String sUB_EMP_NM) {
		SUB_EMP_NM = sUB_EMP_NM;
	}
	public String getSUB_EMP_PHONE() {
		return SUB_EMP_PHONE;
	}
	public void setSUB_EMP_PHONE(String sUB_EMP_PHONE) {
		SUB_EMP_PHONE = sUB_EMP_PHONE;
	}
	...
	public String getNOTIFY_NM() {
		return NOTIFY_NM;
	}
	public void setNOTIFY_NM(String nOTIFY_NM) {
		NOTIFY_NM = nOTIFY_NM;
	}
	...
	public String getREPAIR_TM() {
		return REPAIR_TM;
	}
	public void setREPAIR_TM(String rEPAIR_TM) {
		REPAIR_TM = rEPAIR_TM;
	}
	...
	public String getCBS_YN() {
		return CBS_YN;
	}
	public void setCBS_YN(String cBS_YN) {
		CBS_YN = cBS_YN;
	}
