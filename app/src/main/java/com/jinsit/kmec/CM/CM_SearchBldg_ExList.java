...
public class CM_SearchBldg_ExList extends Dialog implements OnClickListener, OnDismissListener, OnGroupClickListener {



	public CM_SearchBldg_ExList(Context context) {
		super(context);
	...
	public CM_SearchBldg_ExList(Context context, int selTp) {
		super(context);
		// TODO Auto-generated constructor stub
	...
	private ExpandableListView lv_cm_searchList;

	private CM_SearchBldg_Adapter01 adapter02;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cm_searchbldg_exlist);
		activityInit();
	}
	...
	protected void getInstances() {
		...
		lv_cm_searchList = (ExpandableListView) findViewById(R.id.lv_cm_searchList);
		tv01_popTitle = (TextView)findViewById(R.id.tv01_popTitle);
		this.btn_cm_ok = (TextView) findViewById(R.id.btn_cm_ok);
		setEvents();
	}
	...
	protected void setEvents() {
		...
		lv_cm_searchList.setOnGroupClickListener(this);
	}
	@Override
	public boolean onGroupClick(ExpandableListView parent, View v,
								int groupPosition, long id) {
		adapter02.setChecked(groupPosition);
		return false;
	}
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			...
			case R.id.btn_popClose:
				...
				break;
			case R.id.btn_cm_ok:
				CM_SearchBldgInfo_ITEM01 item = null;
				if(adapter02 != null){
					item = adapter02.getSelectedData();
				}

				if(item == null)
				{
					AlertView.showAlert("건물을 선택하세요", context);
					return;
				}
	...
	public class searchBuildingName extends AsyncTask<Void, Void, Void> {
			...
			try {
				...
				try {
					...
					for (int i = 0; i < jsonSize; i++) {
						itemList.add(new  CM_SearchBldgInfo_ITEM01(ejl01.getValue(i,"BLDG_NO"),
								ejl01.getValue(i,"BLDG_NM"),
								ejl01.getValue(i,"ADDR"),
								ejl01.getValue(i,"CS_CD"),
								ejl01.getValue(i,"RUN_ST"),
								ejl01.getValue(i,"CLIENT_DEPT"),
								ejl01.getValue(i,"CLIENT_NM"),
								ejl01.getValue(i,"CLIENT_HP"),
								ejl01.getValue(i,"CLIENT_TEL"),
								ejl01.getValue(i,"CONTR_DT"),
								ejl01.getValue(i,"CONTR_DT_FR_TO"),
								ejl01.getValue(i,"FAULT_DT_FR_TO"),
								ejl01.getValue(i,"INS_DT_FR_TO"),
								ejl01.getValue(i,"EMP_NM_1"),
								ejl01.getValue(i,"EMP_1_HP"),
								ejl01.getValue(i,"EMP_NM_2"),
								ejl01.getValue(i,"EMP_2_HP"),
								ejl01.getValue(i,"CS_DETP_NM")));
					}
		...
		protected void onPostExecute(Void result) {
			...
			adapter02 = new CM_SearchBldg_Adapter01(context, itemList);
			lv_cm_searchList.setAdapter(adapter02);
	...
	private void progress(Boolean isActivated) {
		if (isActivated) {
			CM_SearchBldg_ExList.this.progress = android.app.ProgressDialog.show(
					context, "알림", "조회 중입니다.");
		} else {
			CM_SearchBldg_ExList.this.progress.dismiss();
		}
	}
