...
public class IP_IS02_R00 extends Activity {


	//uiInstances
	Context context;
	TextView tv01_is02_YM_value;
	TextView btn_is_calendar;
	TextView btn02_is02_search;
	GridView gl01_is02_calender;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ip_is02_r00);

		android.app.ActionBar aBar = getActionBar();
		aBar.setTitle("점검계획 내역조회");
	...
	private void getInstances(){
		...
		tv01_is02_YM_value = (TextView) findViewById(R.id.tv01_is02_YM_value);
		btn_is_calendar 	= (TextView) findViewById(R.id.btn_is_calendar);
		btn02_is02_search  = (TextView) findViewById(R.id.btn02_is02_search);
		gl01_is02_calender = (GridView) findViewById(R.id.gl01_is02_calender);
		setEvents();
	}

	private void setEvents(){
		tv01_is02_YM_value.setOnClickListener(listner);
		btn02_is02_search.setOnClickListener(listner);
		btn_is_calendar.setOnClickListener(listner);
		setDefaultValues();
	}

	private void setDefaultValues(){
		tv01_is02_YM_value.setText( DateUtil.getYM() );
		setConfig();
	}
	...
	private void manageCalConfig(){
		...
		gl01_is02_calender.setOnItemClickListener(itemListener);
		...
		public void onClick(View v) {
			switch (v.getId()) {
				...
				case R.id.btn_is_calendar:
					...
					break;
				//조회
				case R.id.btn02_is02_search:
					String strDate = tv01_is02_YM_value.getText().toString();
	...
	OnItemClickListener itemListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View v, int position, long arg3) {
			...
			argMap.put( "csEmpId", cs.getEmpId() );
			argMap.put( "workDt" , myList.get(position).toString() );
			IP_IS02_R01P d01 = new IP_IS02_R01P(context,argMap);
			d01.show();
		}
	};
	...
	public class InspectionPlanHistoryAsync extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				String workMm = tv01_is02_YM_value.getText().toString();
	...
	private void initCalendarAdapter()
	{
		...
		gl01_is02_calender.setAdapter(mCalendarAdapter);
		progress(false);
	}
		...
		switch(requestCode) {
			case 99:
				if (resultCode == RESULT_OK) {
					...
					tv01_is02_YM_value.setText( strDate.substring(0, 7) );
	...
	private void progress(Boolean shallActivated){
		if(shallActivated){
			IP_IS02_R00.this.progress =
					android.app.ProgressDialog.show(context, "알림","조회 중입니다.");
		}else{
			IP_IS02_R00.this.progress.dismiss();
		}
	}
